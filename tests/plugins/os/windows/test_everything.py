...
from dissect.target.helpers.locate.everything import FILE, DIRECTORY
...
# def test_everything_1_7_8_ntfs_efu_folder(target_win: Target, fs_win: VirtualFilesystem) -> None:
#     fs_win.map_file(
#         "\\Program Files\\Everything\\Everything.db",
#         absolute_path("_data/plugins/os/windows/everything/1.7.8/Everything_NTFS_EFU_FOLDER.db"),
#     )
#     target_win.add_plugin(EverythingPlugin)
